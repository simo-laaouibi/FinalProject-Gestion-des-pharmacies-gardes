...
export default function AddGarde() {
    ...
    const popSuccess = () => {
        Swal.fire({
            title: 'Added!!',
            text: "La garde a été ajoutée avec succès.",
            icon: 'success',
            confirmButtonColor: '#3085d6',
            confirmButtonText: 'Ok'
        }).then((result) => {
                                                ...
                                                <tbody class="table-border-bottom-0">
                                                    {
                                                        affectations.map((affectation, index) => (
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <Link class="btn btn-outline-warning mx-2" onClick={() => { popInfo() }}><i class="bx bx-edit-alt me-1"></i>Edit</Link>
                                                                    <a class="btn btn-outline-danger" onClick={() => { popInfo() }}><i class="bx bx-trash me-1"></i> Delete</a>
                                                                </td>
                                                            </tr>
                                                        ))
                                                    }
